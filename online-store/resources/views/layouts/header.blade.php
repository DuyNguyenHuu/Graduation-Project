<div>
    <div class="orderTracking">
        <div>
            <a href="/orders" style="display:flex; text-decoration: none;">
    ...
    <div class="header">
        ...
        <div class="search" style="position: relative;">
            ...
            <div id="searchResult"
                style="position:absolute; top:38px; width:100%; background:white; border:1px solid #ddd; display:none; z-index:100;">
            </div>
        </div>
        <script>
